...
The string type has a rich functionality available, through its [methods](https://docs.python.org/3/library/stdtypes.html#string-methods).
...
Indexes allow us to ask for not just one, but several items.
...
Slices can also be built using the [slice]((https://docs.python.org/3/library/functions.html#slice)) built-in functions, but this is a more avanced topic.
