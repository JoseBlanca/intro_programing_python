...
During the course we recommend to use the editor [Visual Studio Code](https://code.visualstudio.com/) to write Python code. This editor includes its own terminal, so you won't need any other terminal software.
...
A Python program is just a text file with Python code in it and the ".py" extension.
Open Visual Studio Code, and in the File menu, select Open Folder and Open the Folder that you just created.
...
We could run our Python programs using [uv](https://docs.astral.sh/uv/) or directly using the python command.
...
If you prefer not to use uv, substitute "uv run" with python, and run:
